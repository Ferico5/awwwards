      ...
      <div className="container mx-auto px-3 md:-px-10">
        ...
        <div className="flex flex-col w-full gap-7 mb-7">
          <div className="flex flex-col md:flex-row w-full gap-7">
            <BentoTilt className="bento-tilt_1 flex-1 h-128 md:h-[65vh]">
              <BentoCard
            ...
            <div className="flex flex-col flex-1 gap-7">
              <BentoTilt className="bento-tilt_1 h-[15rem] md:h-[31vh]">
                <BentoCard
          ...
          <div className="flex w-full gap-7 flex-col md:flex-row">
            <div className="bento-tilt_2 flex-1">
            ...
            <div className="bento-tilt_2 flex-1">
              <video src="/videos/feature-5.mp4" loop muted autoPlay className="size-full object-cover object-center rounded-md" />
            </div>
          </div>
        </div>
      </div>
